    ...
    return (
        <article  className={`grid grid-cols-2 md:w-4/6 ${imgCharge?"":"animate-pulse"}  mt-10 rounded-sm shadow-md shadow-slate-400 text-slate-800`}>
            ...
            <div className='h-[calc(31rem)] overflow-hidden '>
                <img onLoad={()=>setImgCharge(!imgCharge)} className={` relative opacity-0 object-cover w-full h-full ${imgCharge?"opacity-100":""} transition-opacity ease-in-out duration-10000`} src="https://eccomerce-346201.rj.r.appspot.com/files/storage/download/d6c8e437-af48-4c39-90db-4ebcf3a042c2.jpg" alt="" />
            </div>
